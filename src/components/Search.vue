        ...
        <div class="weather-warp" v-show="isMenus">
          <div class="weather-menus">
            <div class="weather-menu gxs-cell gxs-cells-icon">
              <div class="weather-bd gxs-cell-bd gxs-cell-default"><a href="">个人简历</a></div>
              <div class="weather-ft gxs-cell-ft">最后更新：2017-05-26</div>
            </div>
            <div class="weather-menu gxs-cell gxs-cells-icon">
              <div class="weather-bd gxs-cell-bd gxs-cell-default"><a href="">个人网站</a></div>
